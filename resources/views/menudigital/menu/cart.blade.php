            ...
            <div class="col-xl-6 col-lg-6">
                ...
                @enderror
                        <div class="form-group">
                            ...
                            <label>Nome</label>
                            <input class="form-control" placeholder="" value="{{$usermenu->name}}" readonly>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Phone" value="{{$usermenu->mobile}}" readonly>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <div class="box_order_form">
                    ...
                    <div class="main">
                      ...
                      <form method="POST" action="{{ route('sells-client.store') }}" id="cart-form">
                        ...
                        <input type="hidden" class="form-control"  name="user_menu_id" value="{{$usermenu->id}}" placeholder="First and last name" required>
                ...
                <!-- /box_order_form -->
                <form method="POST" action="{{ route('sellmenu') }}" id="cart-form">
                    @csrf
                    <input type="hidden" class="form-control @error('total') is-invalid @enderror"  name="total" id="totaltaxinput" value="" placeholder="Total" required>
                    <input type="hidden" class="form-control"  name="user_menu_id" value="{{$usermenu->id}}" placeholder="First and last name" required>
                    <input type="hidden" class="form-control @error('delivery_tax') is-invalid @enderror" value="{{$table->id}}" id="taxinput" name="table_id" placeholder="table" required>
                ...
                <div class="box_order">
                    ...
                    <div class="main">
                        <ul>
                            ...
                            <li>Tipo<span>Pedido para mesa: {{$table->name}}</span></li>
                        </ul>
                        <hr>
                        <ul class="clearfix">
                        <?php $sum_total = 0 ?>
                          ...
                          <li><form action="{{URL::to('/destroycart/'.$item->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <ul class="clearfix">
                            {{--<li>Subtotal<span >{{$sum_total}} MT</span></li>
                             <input type="number" id="totalOrder" value="{{$sum_total}}">
                            <li>Taxa de Entrega <span id="tax"></span> </li> --}}
                            <li class="total">Total<span id="totaltax">{{$sum_total}} MT</span></li>
                            
                        </ul>
                         <a href="#" onclick="event.preventDefault();document.getElementById('cart-form').submit();" class="btn_1 gradient full-width mb_5" id="buttonpagar" style="display: block">Pedir agora</a>
