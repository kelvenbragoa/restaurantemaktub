                    ...
                    <div class="main">
                        <table class="styled-table" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$item->id}} (<a href="{{URL::to('/client-invoice-menu/'.$item->id)}}">Ver recibo</a>)</td>
                                   
                                    <td>{{$item->total}} MT</td>
                                    <td>@if ($item->payment ==1 ) <span style="color: green">Confirmada</span> @else <span style="color: tomato">Não Confirmada</span> @endif</td>
                                    <td>
                                        @if ($item->status == 0)<span style="color: green">Pronto</span> @endif 
                                        @if ($item->status == 1)<span style="color: rgb(87, 87, 10)">Pronto</span> @endif 
