		...
		<aside>
            ...
            <form method="POST" action="{{ route('password.update') }}">
				...
				<div class="form-group">
					<input class="form-control @error('email') is-invalid @enderror" type="email" name="email" value="{{ $email ?? old('email') }}" id="email" placeholder="Email" required>
				...
				<button type="submit" class="btn_1 gradient full-width">Repor a password</button>
