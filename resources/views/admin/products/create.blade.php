...
<div class="box_general padding_bottom">
    ...
    <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Adicionar Produto</h2>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 add_top_30">
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Descrição curta" name="short_description" value="{{ old('short_description') }}" required>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Descrição longa do produto <span style="color: tomato">*</span></label>
                  <textarea style="height:100px;" class="form-control" placeholder="Descrição do produto" name="long_description" value="{{ old('long_description') }}" required></textarea>
                </div>
              </div>
            </div>
            <div class="row">
