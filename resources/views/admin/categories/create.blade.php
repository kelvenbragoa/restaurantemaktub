...
<div class="box_general padding_bottom">
    ...
    <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Adicionar Categoria</h2>
    </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea style="height:100px;" class="form-control" placeholder="Descrição da categoria" name="description" required></textarea>
                </div>
              </div>
            </div>
